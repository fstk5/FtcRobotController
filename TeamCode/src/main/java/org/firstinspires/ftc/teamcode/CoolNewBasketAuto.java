...
// 
// @Autonomous(name = "Autonomous Template w/ Encoders")
// 
// public class CoolNewBasketAuto extends LinearOpMode {
...
// 		}
// 		
// 		private void clawVSlide(double speed, int ticks) {
// 			switchMode.initRunToPosition();
// 			clawViper2.setTargetPosition(ticks);
// 			clawViper2.setPower(speed);
// 		}
// 		
